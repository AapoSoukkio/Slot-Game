// Code modified from template that has been taken from this repository  --> https://github.com/odhyan/slot 
...
$(document).ready(function() {
    ...
    */
    ...
    function printResult() {
        var res;
        if(1 == 1) {
            res = "Iso voitto! Voitte lunastaa voittonne ottamalla yhteyttä aapo.soukkio@edu.savonia.fi tai puhelimitse 0452334618 ";
        } else {
            res = "You Lose";
        }
        $('#result').html(res);
